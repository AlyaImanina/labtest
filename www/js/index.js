$(function () {
            ...
            success: function (mydata) {
                ...
                if (myData[lastIndex].status === 1) {
                    for (var i = 0; i < lastIndex; i++) {
                        htmlText = htmlText + "<tr><td><a href='#viewEmailinfo/" 
                        + myData[i].id + "'>" 
                        + myData[i].email + "</a></td></tr>";
                    }
    ...
    var link1 = crossroads.addRoute("viewEmailinfo/{id}", function (id) {
        var datalist = "id=" + id;
        $.ajax({
            type: "post",
            ...
            success: function (mydata) {
                ...
                if (myData.status === 1) {
                    ...
                    $("#tblEmailinfo tbody").html(htmlText);
                }
            },
            error: function () {
                console.log("ajax error!");
